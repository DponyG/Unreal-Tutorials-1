...
#define ORIGINAL_FILE_NAME "UE4Editor-ExcapeFromRoom2.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME ExcapeFromRoom2
#define DEPRECATED_FORGAME DEPRECATED
#define EXCAPEFROMROOM2_API DLLEXPORT
